...
void setup() {
  ...
  controlP5.addButton("Solid",0,300,270,80,19);
  controlP5.addButton("Blink",255,300,290,80,19);
  controlP5.addButton("Breathe",128,300,310,80,19);
...
public void Solid(int theValue) {
...
public void Blink(int theValue) {
...
// function buttonB will receive changes from 
// controller with name buttonB
public void Breathe(int theValue) {
  println("a button event from buttonB: "+theValue);
    port.write(123);
  port.write('P');
}
